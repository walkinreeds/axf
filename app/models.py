...
class CartModel(models.Model):
    user = models.ForeignKey(UserModel, on_delete=models.DO_NOTHING)  # 关联用户
    goods = models.ForeignKey(Goods, on_delete=models.DO_NOTHING)  # 关联商品
...
class OrderGoodsModel(models.Model):
    ...
    order = models.ForeignKey(OrderModel, on_delete=models.DO_NOTHING)  # 关联的订单
